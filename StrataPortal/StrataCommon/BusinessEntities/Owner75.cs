...
namespace Rockend.iStrata.StrataCommon.BusinessEntities
{
    ...
    public class Owner75 : IOwner
	{
        ...
        /// <summary>
        /// Meetings distribution type
        /// </summary>
        [DataMember]
        [Column(Name = "sNoticesIssue")]
        public string NoticesIssue { get; set; }

        /// <summary>
        /// Correspondence distribution type
        /// </summary>
        [DataMember]
        [Column(Name = "sNoticeCorrespondenceIssue")]
        public string NoticeCorrespondenceIssue { get; set; }
	}
}
