...
{
    [DataContract]
    [Table(Name = "OwnersCorporation")]
    public class OwnersCorporation100
    {
        [DataMember]
        ...
        [DataMember]
        [Column(Name = "sBuildingImageFilename")]
        public string BuildingImageFilename { get; set; }

        [DataMember]
        [Column(Name = "lInsuranceValuerID")]
        public Int32? InsuranceValuerID { get; set; }

        [DataMember]
        [Column(Name = "dValuationDue")]
        public DateTime ValuationDue { get; set; }

        [DataMember]
        [Column(Name = "dLastEmailedLevyNotice")]
        public DateTime LastEmailedLevyNotice { get; set; }
