...
namespace Rockend.iStrata.StrataCommon.BusinessEntities
{
    ...
    public class Agency65 : IAgency
    {
        ...
        [Column(Name = "sFSLibraryID")]
        public string FSLibraryID { get; set; }

        [Column(Name = "sFSOwnersCorpFolderID")]
        public string FSOwnersCorpFolderID { get; set; }

        [Column(Name = "sFSLotsFolderID")]
        public string FSLotsFolderID { get; set; }
        ...
        [Column(Name = "sFSPaymentID")]
        public string FSPaymentID { get; set; }
