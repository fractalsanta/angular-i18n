...
namespace Rockend.Common
{
    ...
    /// 
    /// </summary>
    /// <remarks>taken from: https://github.com/wallism/Agile/blob/master/Framework/Agile.Framework.Server/Cache.cs
    /// </remarks>
    public class Cache : ICache
    {
            ...
            where T : class
        {
            lock (padlock)
            {
                ...
                {
                    Logger.Error(ex, "GetCached: {0} (key:{1})", typeof (T).Name, key ?? "none");
                    return null;
                }
            }
        }
