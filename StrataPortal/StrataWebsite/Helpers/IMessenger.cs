...
namespace Rockend.iStrata.StrataWebsite.Helpers
{
    ...
    public interface IMessenger
    {
        ...
        /// <summary>
        /// Get the agenda items associated to the lot & meeting register
        /// </summary>
        /// <param name="lotId">Lot identifier</param>
        /// <param name="meetingRegisterId">Meeting register id</param>
        /// <returns></returns>
        MeetingAgendaReponse GetMeetingAgenda(int lotId, int meetingRegisterId);

        /// <summary>
        /// Sync the motions captured back to the SM database
        /// </summary>
        /// <param name="meetingAgenda">Collection of AgendaItems with MeetingRecordItems</param>
        /// <returns></returns>
        VoteResponse SyncVotesToStrata(MeetingAgendaReponse meetingAgenda);
    }
}
