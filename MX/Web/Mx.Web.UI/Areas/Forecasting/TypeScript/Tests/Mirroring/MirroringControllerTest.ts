...
module Forecasting.Tests {
    ...
    describe("@ts mirroring Controller", (): void => {
        var q: ng.IQService,
            scope: IMirroringControllerScope,
        ...
        var createTestController = (): Forecasting.MirroringController => {
            return new Forecasting.MirroringController(
                scope,
                null,
        ...
        beforeEach((): void => {
            inject(($rootScope: IMirroringControllerScope, $q: ng.IQService): void => {
                q = $q;
                scope = $rootScope;
