...
(function (Inventory) {
    (function (Transfer) {
        ...
        describe("TransferInController", function () {
            ...
            it("gets initialized properly", function () {
                controller = new Transfer.TransferInController(scope, authServiceMock.Object, location, transferStoreServiceMock, translationServiceMock, popupMessageService, routeParamsMock);
...
//# sourceMappingURL=TestTransferInController.js.map
