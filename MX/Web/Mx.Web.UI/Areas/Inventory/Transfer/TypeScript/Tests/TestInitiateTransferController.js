...
(function (Inventory) {
    ...
    (function (Transfer) {
        ...
        (function (Tests) {
            "use strict";
            describe("@ts InitiateTransferController", function () {
                var periodCloseMock;
                ...
                beforeEach(function () {
                    ...
                    controller = new Transfer.InitiateTransferController(scope, authServiceMock.Object, routeParamsMock, translationServiceMock, modalService, location, popupMessageService, transferStoreServiceMock, transfersApiServiceMock, entityServiceMock, formatter, null, transfersServiceMock.Object, null, null, periodCloseMock, new ConstantsMock().Object);
                });
                ...
                it("sets IsOutbound and the right title for request", function () {
                    ...
                    controller = new Transfer.InitiateTransferController(scope, authServiceMock.Object, routeParamsMock, translationServiceMock, modalService, location, popupMessageService, transferStoreServiceMock, transfersApiServiceMock, entityServiceMock, formatter, null, null, null, null, periodCloseMock, new ConstantsMock().Object);
                    rootScope.$digest();
                    expect(scope.IsOutbound).toBe(false);
                ...
                it("outbound submit does not have or try to get no cost items", function () {
                    ...
                    spyOn(controller, "PostTransfer").and.callFake(function () { return promiseHelper.CreateHttpPromise({}); });
                    spyOn(controller, "PostTransferAndUpdateNoCostItems").and.callFake(function () { return promiseHelper.CreateHttpPromise({}); });
                    scope.SubmitRequest().finally(function () {
