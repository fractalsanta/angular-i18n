...
(function (Inventory) {
    (function (Transfer) {
        (function (Tests) {
            ...
            describe("PendingTransferController", function () {
                var promiseHelper, controllerScope, controller, locationService, popupMessageService, translationServiceMock, authServiceMock, routeParams, modalServiceMock, translations, transfersServiceMock, entityServiceMock, formatter;

                var createTestController = function () {
                    return new Transfer.PendingTransferController(controllerScope, routeParams, authServiceMock.Object, translationServiceMock.Object, modalServiceMock, locationService, transfersServiceMock.Object, popupMessageService, entityServiceMock, formatter);
                };
                ...
                it("sets the path when Return() is called", function () {
                    ...
                    expect(locationService.path()).toBe("/Inventory/Transfer/TransferOut");
                });
                ...
                it("updates the quantity when UpdateDetails gets called and quantities have changed", function () {
                    ...
                    resultTransferDetail.TransferQty3 = resultTransferDetail.TransferQty3 + 1;
                    ...
                    expect(controllerScope.Transfer.Details[0].Quantity).toBe(resultTransferDetail.Quantity);
                    expect(controllerScope.Transfer.Details[0].TransferCost).toEqual(resultTransferDetail.TransferCost);
                    expect(controllerScope.Transfer.Details[0].OnHand).toEqual(resultTransferDetail.OnHand);
                });
...
//# sourceMappingURL=TestPendingTransferController.js.map
