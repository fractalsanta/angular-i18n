...
namespace Rockend.iStrata.StrataWebsite.Model
{
    public class LogonModel : ModelBase
    {
        ...
        [Required]
        [Display(Name = "Owner or Executive Member")]
        ...
        {
            Rmh_ServiceAgencyApplication docsService = base.CommunicatorData.LoadAgentServicesByServiceKey(int.Parse(AppKeyHelper.GetApplicationKeyFromUrl()), (int)Rockend.Common.RockendHelper.RwacService.StratePortal);
