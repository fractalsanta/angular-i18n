...
namespace Rockend.iStrata.StrataWebsite.Model
{
    public class LotOwnerModel : ModelBase
    {
        public static LotOwnerModel CreateLotOwnerModel(UserSession userSession, LotResponse response, int index)
        {
            ...
            model.NameOnTitle = response.Owner.NameOnTitle;

            model.FinancialEnteredDate = response.Owner.DateOfEntry;
            model.FinancialPurchasedDate = response.Owner.Purchase;
            ...
            model.OwnershipType = CreateOwnershipType(response.Owner);
        ...
        public static string CreateOwnershipType(Owner owner)
        {
