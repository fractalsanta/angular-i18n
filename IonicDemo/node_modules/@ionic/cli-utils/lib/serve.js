    ...
    gatherDevAppDetails(options, details) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (options.devapp) {
                ...
                const interfaces = network_1.getExternalIPv4Interfaces()
                ...
                const commPort = yield network_1.findClosestOpenPort(exports.DEFAULT_DEVAPP_COMM_PORT);
    ...
    runLab(options, serveDetails) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const labDetails = {
                ...
                port: yield network_1.findClosestOpenPort(options.labPort),
            };
            if (options.ssl) {
    ...
    selectExternalIP(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (options.address === exports.BIND_ALL_ADDRESS) {
                availableInterfaces = network_1.getExternalIPv4Interfaces();
...
class ServeCLI extends events_1.EventEmitter {
    ...
    serve(options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield network_1.isHostConnectable(options.address, options.port);
