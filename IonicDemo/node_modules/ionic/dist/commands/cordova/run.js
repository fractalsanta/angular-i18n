        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (options['livereload']) {
                ...
                if (options.build) {
                    ...
                    // TODO: use runner directly
                    yield build({ config: this.env.config, log: this.env.log, shell: this.env.shell, prompt: this.env.prompt, project: this.project }, inputs, utils_1.generateBuildOptions(metadata, inputs, options));
                }
