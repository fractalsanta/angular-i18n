...
const shell_1 = require("@ionic/cli-utils/lib/shell");
...
${chalk_1.default.cyan('[1]')}: ${chalk_1.default.bold('https://ionicframework.com/docs/cli/starters.html')}
    ...
    preRun(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!inputs[0]) {
                if (proId) {
                    const { AppClient } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/app'));
            ...
            if (projectId) {
                ...
                projectId = options['project-id'] = this.isValidProjectId(inputs[0]) ? inputs[0] : string_1.slugify(inputs[0]);
            }
    ...
    run(inputs, options, runinfo) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { getTopLevel, isGitInstalled } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/git'));
            const { getIonicDevAppText, getIonicProText } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/start'));
            if (!this.schema) {
            ...
            this.namespace.root.project = yield cli_utils_1.getProject(projectDir, undefined, this.env);
            if (!this.project) {
                throw new errors_1.FatalException('Error while loading new project. Please report this error!');
            }
            ...
            if (!this.schema.cloned) {
                ...
                if (options['capacitor']) {
                    yield executor_1.runCommand(runinfo, ['integrations', 'enable', 'capacitor', '--quiet']);
                }
    ...
    getStarterTemplates() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { STARTER_TEMPLATES } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/start'));
    ...
    checkForExisting(projectDir) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const projectExists = yield fs_1.pathExists(projectDir);
            if (projectExists) {
                const confirm = yield this.env.prompt({
                    type: 'confirm',
                    name: 'confirm',
    ...
    findStarterTemplate(template, type, tag) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { STARTER_BASE_URL, getStarterList } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/start'));
            const starterTemplates = yield this.getStarterTemplates();
    ...
    downloadStarterTemplate(projectDir, starterTemplate) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { createRequest, download } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/utils/http'));
            const { tar } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/utils/archive'));
            const tasks = this.createTaskChain();
